...
var ws = new WebSocket("ws://asu-paa:8082/ErzNsk/wsAnswer");
...
function searchInDirectory(varrr) 
{
	...
	//если флаг входа 0 (т.е. соединений нет открытых)
	 if(!nowCount)
	 {
		 ...
		 if(varrr == 'ZP1' || varrr == 'A08P02test' || varrr == 'buttonZP9' || varrr == 'Zp1Ajax' || varrr == 'Zp1taskA8P4' || varrr == 'A08P14'){nowCount=0;} else {nowCount=1;}
